...
- label (boolean | number | string | dict | list; required):
    Accordion label."""
    @_explicitize_args
    def __init__(self, children=None, icon=Component.UNDEFINED, label=Component.REQUIRED, **kwargs):
        self._prop_names = ['children', 'icon', 'label']
        self._type = 'AccordionItem'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'icon', 'label']
