...
- style (dict; optional):
    ...
    @_explicitize_args
    def __init__(self, children=None, class_name=Component.UNDEFINED, cite=Component.UNDEFINED, color=Component.UNDEFINED, icon=Component.UNDEFINED, id=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'cite', 'class_name', 'color', 'icon', 'style']
        self._type = 'Blockquote'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'cite', 'class_name', 'color', 'icon', 'style']
