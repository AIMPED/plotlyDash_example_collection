...
- zIndex (number; optional):
    ...
    @_explicitize_args
    def __init__(self, children=None, autoClose=Component.UNDEFINED, containerWidth=Component.UNDEFINED, id=Component.UNDEFINED, limit=Component.UNDEFINED, notificationMaxHeight=Component.UNDEFINED, position=Component.UNDEFINED, transitionDuration=Component.UNDEFINED, zIndex=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'autoClose', 'containerWidth', 'limit', 'notificationMaxHeight', 'position', 'transitionDuration', 'zIndex']
        self._type = 'NotificationsProvider'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'autoClose', 'containerWidth', 'limit', 'notificationMaxHeight', 'position', 'transitionDuration', 'zIndex']
