...
- withLineNumbers (boolean; optional):
    ...
    @_explicitize_args
    def __init__(self, children=None, class_name=Component.UNDEFINED, colorScheme=Component.UNDEFINED, copiedLabel=Component.UNDEFINED, copyLabel=Component.UNDEFINED, highlightLines=Component.UNDEFINED, id=Component.UNDEFINED, language=Component.REQUIRED, noCopy=Component.UNDEFINED, style=Component.UNDEFINED, trim=Component.UNDEFINED, withLineNumbers=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'class_name', 'colorScheme', 'copiedLabel', 'copyLabel', 'highlightLines', 'language', 'noCopy', 'style', 'trim', 'withLineNumbers']
        self._type = 'Prism'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'class_name', 'colorScheme', 'copiedLabel', 'copyLabel', 'highlightLines', 'language', 'noCopy', 'style', 'trim', 'withLineNumbers']
